...
contract SupplyChain is ConsumerRole , DistributorRole ,RetailerRole ,FarmerRole,Ownable{
  ...
  modifier checkValue(uint _upc,address _buyer) {
    _;
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) public onlyFarmer
  {
    ...
    Item memory newitem;
     newitem.sku=sku;
     newitem.upc=_upc;
     newitem.ownerID=_originFarmerID; //msg.sender;
  ...
  
  {
    ...
    items[_upc].productID=items[_upc].sku+_upc;
